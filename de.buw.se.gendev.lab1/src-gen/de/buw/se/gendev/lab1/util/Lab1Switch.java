...
public class Lab1Switch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case Lab1Package.LESSONS: {
			Lessons lessons = (Lessons) theEObject;
			T result = caseLessons(lessons);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case Lab1Package.QUIZZES: {
			Quizzes quizzes = (Quizzes) theEObject;
			T result = caseQuizzes(quizzes);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case Lab1Package.CERTIFICATES: {
			...
			if (result == null)
				result = caseQuizzes(certificates);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Lessons</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Lessons</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseLessons(Lessons object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Quizzes</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Quizzes</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseQuizzes(Quizzes object) {
		return null;
	}
